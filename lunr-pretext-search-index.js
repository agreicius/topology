...
},
{
  ...
  "number": "1.4.5",
  "title": "Lifting correspondence.",
  "body": " Lifting correspondence   Let be a covering map. Fix , let , and let be the resulting lifting correspondence.    The group homomorphism is an injection.    Let . We have if and only if .    The lifting correspondence gives rise to an injective map . The map is bijective if is path connected.     "
},
{
  "id": "s_top_spaces",
  "level": "1",
...
},
{
  "id": "proof-62",
  "level": "2",
  "url": "s_connected1.html#proof-62",
  "type": "Proof",
  "number": "2.12.1",
  "title": "",
