...
},
{
  ...
  "body": " Comparing metric topologies   Let be two metrics on the set , and let be the topologies they induce. We let and denote - and -metric balls of radius centered at , respectively.  We have if and only if for every and , there exists a such that . In other words if and only if for every , every -metric ball centered at contains a -metric ball centered at .    Both statements follow directly from .   "
},
{
