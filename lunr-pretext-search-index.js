...
},
{
  ...
  "body": " Paths with non-convex codomain  Consider the the nonconvex set and the paths . Both are paths that begin and end at ; yet is intuitively clear that cannot be continuously deformed to without passing through the origin at some point. In other words, the two paths are not path homotopic. This is surprisingly difficult to prove rigorously; we will get to this in the coming sections.  Interestingly, the situation is different if we take and . Visually describe a path homotopy from to , and then see if you can explicitly write down a formula for .  "
},
{
  ...
  "body": " Homotopy equivalence relation   Let and be topological spaces. Fix .    is an equivalence relation on the set of all continuous functions from to .     is an equivalence relation on .      "
},
{
  "id": "convention-2",
  "level": "2",
...
},
{
  ...
  "number": "1.1.11",
  "title": "Path product.",
  "body": " Path product   Let be a topological space, and let . We define a path product operation as follows: .  The function defined is a path from to . Furthermore, if and , then .   "
},
{
...
},
{
  "id": "convention-3",
  "level": "2",
  "url": "s_product2.html#convention-3",
  "type": "Notation",
  "number": "2.7.2",
  "title": "",
